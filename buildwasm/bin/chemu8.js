...
// include: /tmp/tmp6i4a9sb3.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'bin/chemu8.data';
      var REMOTE_PACKAGE_BASE = 'chemu8.data';
...
Module['FS_createPath']("/src", "roms", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_bin/chemu8.data');

      };
      Module['addRunDependency']('datafile_bin/chemu8.data');
    ...
    loadPackage({"files": [{"filename": "/src/roms/IBM Logo.ch8", "start": 0, "end": 132}, {"filename": "/src/roms/mini-lights-out.ch8", "start": 132, "end": 695}, {"filename": "/src/roms/octojam2title.ch8", "start": 695, "end": 1935}, {"filename": "/src/roms/pong.ch8", "start": 1935, "end": 2181}], "remote_package_size": 2181});

  })();

// end include: /tmp/tmp6i4a9sb3.js
// include: /tmp/tmpq_wj46mj.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpq_wj46mj.js
// include: /tmp/tmphk5zg1wf.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmphk5zg1wf.js
...
var ASM_CONSTS = {
 ...
 155003: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 155086: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 155155: () => { return window.innerWidth; },  
 155185: () => { return window.innerHeight; }
};
